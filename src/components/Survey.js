...
function Survey() {
    ...
    useEffect(() => {
        ...
        get(child(dbRef, "/surveys/" + newSurveyKey + "/questions")).then((snapshot) => {
            if (snapshot.exists()) {
            ...
            {isLoading ? (
                ...
                <div className="content">
                    <div className="headerBar">
                        ...
                        <div>
                            {isEditing ? (
                                <button className="btn btn-primary edit" type="button" onClick={saveQuestions}>Save</button>
                            ) : (
                                questionsArray.length > 0 && (
                                    <button className="btn btn-primary save" type="button" onClick={editQuestions}>Edit</button>
                                )
                            )}
                                </div>
                            </div>
                                                    ...
                                                    <div className="questionType">
                                                        ...
                                                        >
                                                                {selectedQuestionType ? (
                                                                    ...
                                                                    <img
                                                                    className="icon"
                                                                    src={selectedQuestionType.icon}
                                                                    alt={selectedQuestionType.name}
                                                                />
                                                            ...
                                                            <div className="formInputs">
                                                                ...
                                                                />
                                                                    ...
                                                                    <div className="inputGroup">
                                                                        <label className="formInputLabel">Question Description: </label>
                                                                        <input
                                                                        name="description"
                                                                        className="formInput"
                                                                        value={desc}
